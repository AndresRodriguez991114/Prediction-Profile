...
#  Cargar el dataset de Ocupados
file_path = 'model/CSV/Ocupados.CSV'  # Ajusta la ruta si es necesario
df = pd.read_csv(file_path, sep=';', encoding='latin1')

#  Filtrar columnas relevantes
columns_needed = ['P6040', 'P6080', 'P6240', 'P6020', 'INGLABO']  # Edad, Educación, Horas, Sexo, Ingreso
...
#  Codificar la variable 'sex' (1: Hombre, 2: Mujer)
...
#  Codificar 'sex' por compatibilidad, aunque ya es numérico
le = LabelEncoder()
